...
#subprocess.run(f"conda run -n pfam_scan python pfam_pk_nb.py --fasta {protein_path}",shell=True)
...
#subprocess.run(f"conda run -n pfam_scan python pfam_lysm.py --fasta {protein_path}",shell=True)
subprocess.run(f"conda run -n pfam_scan python pfam_tir_rpw8.py --fasta {protein_path}",shell=True)
